    ...
    <div class="col-sm-8 text-left">
        <form action="" enctype="multipart/form-data" class="span8 form-inline" method="post">
            <div class="modal-body">
                ...
                <h4>Type a user's Email & hit the Inactive button to inactive his membership of smamcian</h4>
            </div>
            <div class="modal-footer">
                <button name="btnSubmit" id="btnSubmit" type="submit" class="btn btn-success">Inactive</button>
            </div>
        </form>
        <?php
        ...
        <table class="table table-bordered">
            ...
            while ($i < $num) {
                ...
                <tr>
                    ...
                    <td><input data-userid="<?php echo $userId; ?>" data-useremail="<?php echo $userEmail; ?>"
                               type="submit" class="reviewButton btn btn-success" name="approve" value="approve"/>
                        <input data-userid="<?php echo $userId; ?>" type="submit" class="reviewButton btn btn-danger"
        ...
        $(document).ready(function () {
            $('.reviewButton').click(function () {
                ...
                var ajaxurl = 'ajax.php',
                    data = {'action': clickBtnValue, 'user_id': userId, 'user_email': userEmail};
