    ...
    <div class="col-sm-8 text-left">
        <form action="" enctype="multipart/form-data" class="span8 form-inline" method="post">
            <div class="modal-body">
                ...
                <h4>Type a user's Email & hit the Add Admin button to add him as a admin</h4>
            </div>
            <div class="modal-footer">
                <button name="btnSubmit" id="btnSubmit" type="submit" class="btn btn-success">Add Admin</button>
            </div>
        </form>
        <?php
        if (isset($_POST["btnSubmit"]) && $_REQUEST['email']) {
            $sql = "UPDATE USER SET user_type_id = 2 where user_email='" . ($_POST['email']) . "'";
        ...
        <table class="table table-bordered">
            ...
            while ($i < $num) {
                ...
                <tr>
                    ...
                    <td>
                        <input data-useremail="<?php echo $userEmail; ?>" type="submit"
                               class="reviewButton btn btn-danger" name="removeAdmin" value="removeAdmin"/>
                    </td>
                </tr>
        ...
        $(document).ready(function () {
            $('.reviewButton').click(function () {
                ...
                var ajaxurl = 'ajax.php',
                    data = {'action': clickBtnValue, 'user_email': userEmail};
